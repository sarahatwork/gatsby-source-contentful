...
module.exports = (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* ({
    ...
    try {
      ...
      let query = syncToken && !didRunFirstFetchFromExportFile ? { nextSyncToken: syncToken } : { initial: true };
    ...
    currentSyncData.entries = entries.map(function (e) {
      if (e) {
