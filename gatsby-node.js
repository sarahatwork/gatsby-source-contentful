...
exports.sourceNodes = (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* ({ boundActionCreators, getNodes, hasNodeChanged, store, traceId }, { spaceId, accessToken, host, exportFile }) {
    const {
      createNode,
      deleteNodes,
      touchNode,
    ...
    const existingNodes = getNodes().filter(function (n) {
